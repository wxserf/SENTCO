...
Provides REST endpoints and OAuth callback handling
"""
...
def load_config() -> dict:
    ...
    return {
        ...
        'callback_url': os.getenv('EVE_CALLBACK_URL', 'http://localhost:8000/callback'),
    ...
    for filename in os.listdir('.'):
        if filename.startswith('character_') and filename.endswith('.json'):
            try:
                ...
                print(f"Failed to load character from {filename}: {e}")
